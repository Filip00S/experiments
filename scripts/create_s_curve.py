...
def main():
    parser = argparse.ArgumentParser(description="Create S-Curve dataset for dimensionality reduction.")
    ...
    print(f"Generating S-Curve dataset with {args.n_samples} samples and {args.noise} noise...")
    # Generate S-Curve dataset
    X, _ = make_s_curve(n_samples=args.n_samples, noise=args.noise, random_state=42)
    ...
    file_path = os.path.join(args.output_dir, "s_curve-euclidean.hdf5")
    ...
    print("S-Curve dataset created and saved successfully.")
